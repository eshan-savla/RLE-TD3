...
def main(agent_type:str):
    ...
    obs, _ = env.reset()
    avg_return, avg_return_stddev, episode_no, returns, stddevs = compute_avg_return(env, agent, num_episodes=150, max_steps=1000, render=False)
...
if __name__ == '__main__':
    main("td3")             #speficy the algorithm/ agent type ("ddpg" or "td3")